	...
	<section class="banner_one_section">
		<div class="bo_bg">
			 <?php if(!empty($add_banner_image)){ ?>
				...
				<?php }else{ ?>
			<img class="img-desktop" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/banner-services-renovation.jpg" alt="" />
			<?php } ?>
		...
		<div class="serdrag_part">
			<div class="container_big" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="1000">
				<div class="serdrag_main">
					...
					<div class="serdrag_box">
						<a href="<?php echo $add_link['url']; ?>">
							<div class="serdrag_count"><?php echo $add_number; ?></div>
