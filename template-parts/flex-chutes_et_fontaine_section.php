<?php
     	...
     	?>
	<section class="enbet_section" id="chutes-et-fontaines">
		<div class="container_big">
			<div class="enbet_main">
				<div class="enbet_left" data-aos="fade-up" data-aos-duration="1200">
				<?php if(!empty($add_title)) { ?>
					<h3 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="100"><?php echo $add_title; ?></h3>
				<?php } ?>
				<?php if(!empty($add_description)) { ?>
					<?php echo $add_description; ?>
					<?php } ?>

					<?php if( have_rows('add_links_copy') ): ?>
			    <?php $delay=1; while( have_rows('add_links_copy') ): the_row();
		     ...
		     <?php endif; ?>
				...
				<div class="enbet_right">
					<div class="enbet_on">
						...
						<?php }else{ ?>
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/produits_03-min.jpg" alt="" />
					<?php } ?>
					</div>
					<div class="enbet_tw parallax_scroll">
						...
						<?php }else{ ?>
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/produits_04-min.jpg" alt="" />
					<?php } ?>
					</div>
				</div>
			</div>
