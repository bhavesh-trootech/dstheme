...
$finalurl = preg_replace($pattern, '', get_site_url().'/'.$GLOBALS['wp']->request);
				 ?>
					<li><a data-href="<?php echo $finalurl; ?>/" href="<?php echo $add_portfolio_page_link['url']; ?>" class="portfoliopagelink"><?php _e( 'VOIR TOUS', 'dstheme' ); ?></a></li><?php $termscategory = get_terms( array( 
			    ...
			    'hide_empty' => true,
					...
					if($term_id == $term->term_id){
						...
						?>
					<li><a class="<?php echo $cl; ?>" href="<?php echo get_term_link( $term->term_id); ?>" data-id="<?php echo $term->term_id; ?>"><?php echo $term->name; ?></a></li>
				<?php } ?>
				</ul>
			</div>
		</div>
